...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251005045308_Initial")]
            ...
            modelBuilder.Entity("Domain.Entities.SyncSchedule", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("22032dc9-7cef-43c3-a005-7b5e746a89e7"),
                            CronExpression = "0 0 0 * * ?",
                            Enabled = true,
                            JobKey = "UpdateProviders",
                            LastModifiedUtc = new DateTime(2025, 10, 5, 4, 53, 8, 173, DateTimeKind.Utc).AddTicks(5640)
                        },
                        new
                        {
                            Id = new Guid("cc4d4742-978c-43bd-8303-fa0e5992003c"),
                            CronExpression = "0 0 0 * * ?",
                            Enabled = true,
                            JobKey = "UpdateMaterials",
                            LastModifiedUtc = new DateTime(2025, 10, 5, 4, 53, 8, 173, DateTimeKind.Utc).AddTicks(5770)
                        },
                        new
                        {
                            Id = new Guid("f0092452-d3da-4034-82c0-42e60c841d85"),
                            CronExpression = "0 0 0 * * ?",
                            Enabled = true,
                            JobKey = "UpdateMerchandiseEntry",
                            LastModifiedUtc = new DateTime(2025, 10, 5, 4, 53, 8, 173, DateTimeKind.Utc).AddTicks(5780)
                        },
                        new
                        {
                            Id = new Guid("a4d347ab-c00e-40d5-bf89-8ea930eb981c"),
                            CronExpression = "0 0 0 * * ?",
                            Enabled = true,
                        ...
                        new
                        {
                            Id = new Guid("7969ba0a-af1c-477d-9a18-459a97454a7f"),
                            CronExpression = "0 0 0 * * ?",
                            Enabled = true,
